...
## [0.25.0] - 2025-12-15
### Added
- Add type-aware option and rules
...
## [0.19.0] - 2025-04-14
### Added
- Export all methods from @eslint/config-helpers
- Bundle dist files
...
- Disable sonarjs/todo-tag

## [0.18.4] - 2025-02-28
### Fixed
- Ignore imported name casings
- Do not lint file names for certain frameworks
- Disable no-useless-path-segments
...
[0.17.2]: https://github.com/arianrhodsandlot/eslint-config/compare/v0.25.4...v0.17.2
[0.25.4]: https://github.com/arianrhodsandlot/eslint-config/compare/v0.25.3...v0.25.4
...
[0.24.1]: https://github.com/arianrhodsandlot/eslint-config/compare/v0.24.0...v0.24.1
